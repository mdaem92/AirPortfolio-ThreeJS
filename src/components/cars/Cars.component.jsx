    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <group name="keyLight" position={[51.84, 35.17, 67.67]} rotation={[1.3, 0.18, -0.58]}>
          <directionalLight name="keyLight_Orientation" intensity={8} color="#38464f" rotation={[-Math.PI / 2, 0, 0]}>
            <group position={[0, 0, -1]} />
          </directionalLight>
        </group>
        ...
        <group name="police_car" position={[58.08, 200, 46.74]} rotation={[Math.PI, 0, Math.PI]} scale={0.93}>
        ...
        <group name="turningTaxi" position={[54.24, 200, -34.57]} scale={0.93}>
