    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <group name="rearLight1" position={[-32.59, 7.01, -17.31]} rotation={[Math.PI / 2, 0, 0]} scale={0.55}>
          <spotLight name="rearLight1_Orientation" intensity={200} angle={0.42} penumbra={0.19} decay={2} rotation={[-Math.PI / 2, 0, 0]}>
            <group position={[0, 0, -1]} />
          </spotLight>
        </group>
        ...
        <group name="rearLight3" position={[-12.08, 5.95, 4.48]} rotation={[Math.PI / 2, 0, 0]} scale={0.32}>
          <spotLight name="rearLight3_Orientation" intensity={200} angle={0.42} penumbra={0.19} decay={2} rotation={[-Math.PI / 2, 0, 0]}>
            <group position={[0, 0, -1]} />
          </spotLight>
        </group>
        <group name="planeGreenLight" position={[-52.9, 5.95, 5.53]} rotation={[-Math.PI / 2, 0, 0]} scale={0.49}>
          <spotLight name="planeGreenLight_Orientation" intensity={100} angle={0.22} penumbra={0.26} decay={2} color="#ff0708" rotation={[-Math.PI / 2, 0, 0]}>
            <group position={[0, 0, -1]} />
          </spotLight>
        </group>
        <group name="rearLight2" position={[-53.04, 5.95, 4.48]} rotation={[Math.PI / 2, 0, 0]} scale={0.32}>
          <spotLight name="rearLight2_Orientation" intensity={200} angle={0.42} penumbra={0.19} decay={2} rotation={[-Math.PI / 2, 0, 0]}>
            <group position={[0, 0, -1]} />
          </spotLight>
        </group>
        <group name="planeRedLight" position={[-12.26, 5.95, 5.53]} rotation={[-Math.PI / 2, 0, 0]} scale={0.49}>
          <spotLight name="planeRedLight_Orientation" intensity={100} angle={0.22} penumbra={0.26} decay={2} color="#025500" rotation={[-Math.PI / 2, 0, 0]}>
            <group position={[0, 0, -1]} />
          </spotLight>
        </group>
        ...
        <mesh name="aboutmeArea" castShadow receiveShadow geometry={nodes.aboutmeArea.geometry} material={nodes.aboutmeArea.material} position={[52.35, 4.26, 12.32]} scale={[0.09, 0.54, 0.36]} />
        <mesh name="projectsArea" castShadow receiveShadow geometry={nodes.projectsArea.geometry} material={nodes.projectsArea.material} position={[52.35, 4.26, 10.97]} scale={[0.1, 0.59, 0.4]} />
        <mesh name="skillsArea" castShadow receiveShadow geometry={nodes.skillsArea.geometry} material={nodes.skillsArea.material} position={[52.35, 4.26, 9.71]} scale={[0.1, 0.6, 0.4]} />
        <mesh name="linkedinArea" castShadow receiveShadow geometry={nodes.linkedinArea.geometry} material={nodes.linkedinArea.material} position={[52.35, 4.26, 8.5]} scale={[0.1, 0.6, 0.4]} />
        <mesh name="spotlightTarget3" castShadow receiveShadow geometry={nodes.spotlightTarget3.geometry} material={nodes.spotlightTarget3.material} position={[56.81, 1.05, 4.66]} scale={0.84} />
        <mesh name="spotlightTarget2" castShadow receiveShadow geometry={nodes.spotlightTarget2.geometry} material={nodes.spotlightTarget2.material} position={[56.81, 1.05, -14.44]} scale={0.84} />
        <mesh name="spotLightTarget1" castShadow receiveShadow geometry={nodes.spotLightTarget1.geometry} material={nodes.spotLightTarget1.material} position={[56.81, 1.05, -33.64]} scale={0.84} />
        <mesh name="spotlightTarget4" castShadow receiveShadow geometry={nodes.spotlightTarget4.geometry} material={nodes.spotlightTarget4.material} position={[56.81, 1.05, 26.35]} scale={0.84} />
        <mesh name="spotlightTarget5" castShadow receiveShadow geometry={nodes.spotlightTarget5.geometry} material={nodes.spotlightTarget5.material} position={[56.81, 1.05, 44.3]} scale={0.84} />
        <mesh name="planeGreenLightTarget" castShadow receiveShadow geometry={nodes.planeGreenLightTarget.geometry} material={nodes.planeGreenLightTarget.material} position={[-52.9, 5.95, 6.7]} scale={0.34} />
        <mesh name="planeRedLightTarget" castShadow receiveShadow geometry={nodes.planeRedLightTarget.geometry} material={nodes.planeRedLightTarget.material} position={[-12.26, 5.95, 7.05]} scale={0.34} />
        ...
        <group name="engine2" position={[-38.5, 3.02, 14.62]} rotation={[Math.PI / 2, 0, 0]} scale={0.41}>
        ...
        <group name="luggageTrailer" position={[-45.53, 1.36, -12.44]} rotation={[-Math.PI, -1.44, -Math.PI]} scale={[0.81, 0.96, 1.43]}>
          <mesh name="Cube186" castShadow receiveShadow geometry={nodes.Cube186.geometry} material={materials.airplane_white} />
          <mesh name="Cube186_1" castShadow receiveShadow geometry={nodes.Cube186_1.geometry} material={materials.window} />
          <mesh name="Cube186_2" castShadow receiveShadow geometry={nodes.Cube186_2.geometry} material={materials['black.006']} />
          <mesh name="Cube186_3" castShadow receiveShadow geometry={nodes.Cube186_3.geometry} material={materials.metal} />
          <mesh name="Cube186_4" castShadow receiveShadow geometry={nodes.Cube186_4.geometry} material={materials.taillights} />
        </group>
        ...
        <mesh name="runwayWhiteCar" castShadow receiveShadow geometry={nodes.runwayWhiteCar.geometry} material={materials['Material.009']} position={[-19.72, 1.42, -20.94]} rotation={[0, -0.77, 0]} scale={[1.22, 0.26, 2.57]} />
        ...
        <mesh name="billboardLCD" castShadow receiveShadow geometry={nodes.billboardLCD.geometry} material={materials.mainScreen} position={[52.43, 4.43, 10.43]} rotation={[Math.PI / 2, 0, -Math.PI / 2]} scale={3.32} />
        ...
        <mesh name="infoLCD1" castShadow receiveShadow geometry={nodes.infoLCD1.geometry} material={materials.aboutMePage} position={[29.41, 3.69, 20.57]} rotation={[Math.PI / 2, 0, -Math.PI / 2]} scale={[1.6, 2.83, 3.02]} />
        ...
        <group name="satellite" position={[15.54, 35.07, -27.26]} rotation={[0, 0, Math.PI]} scale={[0.04, 0.04, 0.79]}>
          <mesh name="Cube014" castShadow receiveShadow geometry={nodes.Cube014.geometry} material={materials.RED} />
          <mesh name="Cube014_1" castShadow receiveShadow geometry={nodes.Cube014_1.geometry} material={materials.metal} />
        </group>
        <group name="conveyor-truck" position={[-37.06, 2.21, 1.08]} scale={[3.69, 0.8, 1]}>
        ...
        <mesh name="infoDisplay1" castShadow receiveShadow geometry={nodes.infoDisplay1.geometry} material={materials.dark_metal_frame} position={[29.26, 3.46, 20.62]} scale={[0.08, 1.62, 1.51]} />
